...
- [x] 1. Core: Settings Model and Relay Operations
  - [x] 1.1 Create `crates/zvault-core/src/settings.rs` module
  ...
  - [x] 1.2 Add `settings: VaultSettings` field to `Vault` struct
  ...
  - [x] 1.3 Implement relay URL validation and normalization
  ...
  - [x] 1.4 Implement relay CRUD operations
  ...
  - [x] 1.5 Write unit tests for settings module
...
- [x] 2. Checkpoint: `cargo test -p zvault-core --all-features` passes

- [x] 3. CLI: Relay Subcommands
  - [x] 3.1 Add `Relay` command with `RelayAction` subcommand enum to CLI
    - Variants: List, Add, Remove, Enable, Disable, Reset
    - All take `--vault <path>` argument
    - _Requirements: 3.1–3.8_

  - [x] 3.2 Implement `cmd_relay_list`
...
- [x] 4. Checkpoint: CLI builds, relay commands work

- [x] 5. Desktop Tauri: Relay Settings Commands
  - [x] 5.1 Implement Tauri commands for relay management
  ...
  - [x] 5.2 Register relay commands in Tauri Builder

- [x] 6. WASM Bindings: Relay Operations
  - [x] 6.1 Export relay operations for the extension
...
- [x] 7. Extension Background: Relay Message Handlers
  - [x] 7.1 Add relay message types and handlers
...
- [x] 8. React UI: Relay Settings Component
  - [x] 8.1 Create `RelaySettings` component
  ...
  - [x] 8.2 Integrate RelaySettings into desktop Settings page
    - Wire to Tauri invoke commands
    - _Requirements: 4.1–4.6_

  - [x] 8.3 Integrate RelaySettings into extension settings view
    - Wire to browser.runtime.sendMessage
    - _Requirements: 5.1–5.3_

- [x] 9. Sync Engine: Use Vault Relays
  - [x] 9.1 Update sync engine to accept relay list parameter
